...
namespace System
{
    ...
    public static class GeodesicEx
    {
        ...
        {
            var gpt = NETGeographicLib.GeodesicUtils.DefaultGeodesic.Direct(startPt.ToGeoPoint(), azimuth, length);
        ...
        {
            double res;
            NETGeographicLib.GeodesicUtils.DefaultGeodesic.Inverse(start.ToGeoPoint(), point.ToGeoPoint(), out res);
            return res;
        }
        ...
        public static double GeodesicAzimuthTo(this MapPoint start, MapPoint point)
        {
            double azi1; 
            double azi2;
            NETGeographicLib.GeodesicUtils.DefaultGeodesic.Inverse(start.ToGeoPoint(), point.ToGeoPoint(), out azi1, out azi2);
            return azi1;
        }
        ...
        public static double GeodesicLength(this IList<MapPoint> points)
        {
            ...
            var earth = NETGeographicLib.GeodesicUtils.DefaultGeodesic;
            double lenSum = 0.0;
